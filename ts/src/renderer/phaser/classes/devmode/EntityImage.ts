class EntityImage {
	...
	updateOutline (hide?): void {
		...
		if (this.devModeTools.entityEditor.selectedEntityImage === this) {
			...
			const smallDistance = 20 / this.scene.cameras.main.zoom / taro.client.resolutionCoefficient;
			const largeDistance = 25 / this.scene.cameras.main.zoom / taro.client.resolutionCoefficient;
