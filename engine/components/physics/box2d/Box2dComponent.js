			...
			if (self.engine == 'crash' || self.engine == 'VOXEL') {
				...
				bodies.forEach(body => {
					...
					if (entity) {
						...
						if (!isNaN(x) && !isNaN(y)) {
							entity.body.setPosition([x / entity._b2dRef._scaleRatio, y / entity._b2dRef._scaleRatio, 0]);
						}
