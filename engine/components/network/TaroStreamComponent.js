	...
	_onStreamCreate: function (data) {
		...
		if (transformData) {
			var ntransdata = [
				...
				parseInt(transformData[6], 16) / 1000,
				parseInt(transformData[7], 16) / 1000,
				parseInt(transformData[8], 16) / 1000,
				parseInt(transformData[9], 16) / 1000,
			]; // px, py, pz, rx, ry, rz
			console.log(ntransdata);
		}
