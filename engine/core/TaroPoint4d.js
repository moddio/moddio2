/**
 * Creates a new 3d point (x, y, z, w).
 */
var TaroPoint4d = TaroClass.extend({
	classId: 'TaroPoint4d',

	init: function (x, y, z, w, floor) {
	 ...
	 * @param {TaroPoint4d} point The point to compare data with.
	 * @return {Boolean}
	 */
	 ...
	 * @param {TaroPoint4d} point The point to copy values from.
	 * @returns {*}
	 */
	copy: function (point) {
		this.x = point.x;
	 ...
	 * and returns a new TaroPoint4d whose values are the result.
	 * @param point
	 * @return {*}
	 */
	addPoint: function (point) {
		return new TaroPoint4d(this.x + point.x, this.y + point.y, this.z + point.z);
	},
	...
	multiply: function (x, y, z) {
		return new TaroPoint4d(this.x * x, this.y * y, this.z * z);
	},

	/**
	 * Multiplies this point's data by the point specified
	 * and returns a new TaroPoint4d whose values are the result.
	 * @param {TaroPoint4d} point
	 * @return {*}
	 */
	...
	dividePoint: function (point) {
		...
		return new TaroPoint4d(newX, newY, newZ);
	},
	...
	/**
	 * Returns a clone of this TaroPoint4d's data as a new instance.
	 * @return {*}
	 */
	clone: function () {
		return new TaroPoint4d(this.x, this.y, this.z);
	},
	 ...
	 * TaroPoint4d whose values are the result.
	 * @param endPoint
	 * @param startTime
	 * @param currentTime
	 * @param endTime
	 ...
	 * @return {TaroPoint4d} A new point with the rotated x, y.
	 */
	rotate: function (radians) {
		...
		return new TaroPoint4d(x, y, this.z);
	},
